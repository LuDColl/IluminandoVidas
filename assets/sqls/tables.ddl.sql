...
create table aluno (
    ...
    str_complemento varchar(50) null,
    str_bairro varchar(30) not null,
    str_escola varchar(100) not null,
    str_serie varchar(30) not null,
    str_periodo varchar(20) not null,
    str_nomemae varchar(100) not null,
    str_enderecocomercialmae varchar(100) null,
    int_dddmae int not null,
    int_telefonemae int not null,
    int_dddcomercialmae int null,
    int_telefonecomercialmae int null,
    str_nomepai varchar(100) not null,
    str_enderecocomercialpai varchar(100) null,
    int_dddpai int not null,
    int_telefonepai int not null,
    int_dddcomercialpai int null,
    int_telefonecomercialpai int null,
    bit_ativo boolean not null,
    fk_img int null,
